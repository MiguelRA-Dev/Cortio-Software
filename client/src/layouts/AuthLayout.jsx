    ...
    <div className="flex min-h-screen bg-bg">
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden border-r border-border bg-surface p-12 lg:flex">
        ...
        <div className="relative">
          <span className="text-2xl font-semibold tracking-tight text-ink">BarberMAX</span>
        </div>
        ...
        <div className="relative text-sm text-muted">© {new Date().getFullYear()} BarberMAX</div>
      </div>
